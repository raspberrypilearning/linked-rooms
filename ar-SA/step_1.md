...
div>s كروابط قابلة للنقر + "أضف خلفية لغرفة الألعاب" - أضف صورة خلفية + "أجعله مشروعك!" - أضف غرف أخرى عن طريق المهارات التي تعلمتها + "إضافة مؤشر رئيسي" - متعة إضافية اختيارية للذين أكملوا المشروع
