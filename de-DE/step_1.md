...
**Anleitung**: Klicke auf die Türen, um dich zwischen den Räumen zu bewegen.
...
* "Füge weitere Türen hinzu!" - Verwende <div>
      ...
      <ul>
        <li>
          <a href="resources/rooms-project-resources.zip">.zip-Datei mit allen Projektressourcen</a>
        </li>
        <li>
      ...
      <ul>
        <li>
          <a href="resources/rooms-volunteer-resources.zip">.zip-Datei mit allen fertig gestellten Projektressourcen</a>
        </li>
        <li>
