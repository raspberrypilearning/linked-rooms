...
이 프로젝트를 인쇄하려면 [프린트용 문서](https://projects.raspberrypi.org/en/projects/linked-rooms/print)를 사용하십시오.
...
div> 를 클릭할 수 있는 링크로 추가하기 + "게임 내 방에 배경화면 추가" - 배경 이미지 추가 + "자신의 방으로 만들기!" - 배운 기술을 활용해 더 많은 방 추가하기 + "키 커서 추가하기" - 프로젝트를 완료한 사람들은 재미있는 옵션을 추가해 보기
